...
export default function TrollslandeApp() {
  const specialAllOptions = [
    ...
    "-- Alla juvelvingar --",
    "-- Alla praktfjärilar --",
    "-- Alla bastardsvärmare --",
    "-- Alla metallvingar --"
  ];

  const speciesGroups = {
    "-- Alla tjockhuvuden --": [
      "Backvisslare", "Blomvisslare", "Gulfläckig glanssmygare", "Kattunvisslare", "Mindre tåtelsmygare",
      "Myrvisslare", "Silversmygare", "Skogsvisslare", "Smultronvisslare", "Svartfläckig glanssmygare", "Ängssmygare"
    ],
    "-- Alla riddarfjärilar --": [
      "Apollofjäril", "Makaonfjäril", "Segelfjäril"
    ],
    "-- Alla vitfjärilar --": [
      "Aurorafjäril", "Citronfjäril", "Fjällhöfjäril", "Grönfläckig vitfjäril", "Hagtornsfjäril",
      "Högnordisk höfjäril", "Kålfjäril", "Ljusgul höfjäril", "Rapsfjäril", "Rovfjäril",
      "Rödgul höfjäril", "Skogsvitvinge", "Svavelgul höfjäril", "Ängsvitvinge"
    ],
    "-- Alla juvelvingar --": [
      "Alkonblåvinge", "Almsnabbvinge", "Brun blåvinge", "Busksnabbvinge", "Eksnabbvinge",
      "Eldsnabbvinge", "Fetörtsblåvinge", "Fjällvickerblåvinge", "Grönsnabbvinge", "Gullvivefjäril",
      "Hedblåvinge", "Högnordisk blåvinge", "Klöverblåvinge", "Kortsvansad blåvinge", "Krattsnabbvinge",
      "Ljungblåvinge", "Midsommarblåvinge", "Mindre blåvinge", "Mindre guldvinge", "Puktörneblåvinge",
      "Rödfläckig blåvinge", "Silverblåvinge", "Svartfläckig blåvinge", "Tosteblåvinge", "Turkos blåvinge",
      "Violett blåvinge", "Violett guldvinge", "Violettkantad guldvinge", "Vitfläckig guldvinge", "Väpplingblåvinge",
      "Ängsblåvinge"
    ],
    "-- Alla praktfjärilar --": [
      "Amiral", "Arktisk pärlemorfjäril", "Asknätfjäril", "Aspfjäril", "Aspfuks",
      "Aspskimmerfjäril", "Berggräsfjäril", "Brun gräsfjäril", "Brunfläckig pärlemorfjäril", "Bäckpärlemorfjäril",
      "Disas gräsfjäril", "Dvärgpärlemorfjäril", "Dårgräsfjäril", "Fjällgräsfjäril", "Fjällpärlemorfjäril",
      "Frejas pärlemorfjäril", "Friggas pärlemorfjäril", "Gulringad gräsfjäril", "Hedpärlemorfjäril", "Högnordisk pärlemorfjäril",
      "Kamgräsfjäril", "Kartfjäril", "Kvickgräsfjäril", "Körsbärsfuks", "Lappnätfjäril",
      "Luktgräsfjäril", "Monark", "Myrgräsfjäril", "Myrpärlemorfjäril", "Nässelfjäril",
      "Prydlig pärlemorfjäril", "Påfågelöga", "Pärlgräsfjäril", "Sandgräsfjäril", "Schackbräde",
      "Silverstreckad pärlemorfjäril", "Skogsgräsfjäril", "Skogsnätfjäril", "Skogspärlemorfjäril", "Skuggpärlemorfjäril",
      "Slåttergräsfjäril", "Sorgmantel", "Sotnätfjäril", "Starrgräsfjäril", "Storfläckig pärlemorfjäril",
      "Svartringlad pärlemorfjäril", "Svingelgräsfjäril", "Sälgskimmerfjäril", "Tallgräsfjäril", "Tistelfjäril",
      "Tryfjäril", "Tundragräsfjäril", "Videfuks", "Vinbärsfuks", "Vitgräsfjäril",
      "Väddnätfjäril", "Älggräspärlemorfjäril", "Ängsnätfjäril", "Ängspärlemorfjäril"
    ],
    "-- Alla bastardsvärmare --": [
      "Bredbrämad bastardsvärmare", "Fjällbastardsvärmare", "Klubbsprötad bastardsvärmare", "Mindre bastardsvärmare",
      "Sexfläckig bastardsvärmare", "Smalsprötad bastardsvärmare"
    ],
    "-- Alla metallvingar --": [
      "Ängsmetallvinge"
    ]
  ...
  const allSpecies = [
    ...speciesGroups["-- Alla tjockhuvuden --"],
    ...speciesGroups["-- Alla riddarfjärilar --"],
    ...speciesGroups["-- Alla vitfjärilar --"],
    ...speciesGroups["-- Alla juvelvingar --"],
    ...speciesGroups["-- Alla praktfjärilar --"],
    ...speciesGroups["-- Alla bastardsvärmare --"],
    ...speciesGroups["-- Alla metallvingar --"]
  ...
  const selectedSpeciesList = useMemo(() => {
    ...
    if (selectedSpecies === "-- Alla dagfjärilar --") return allSpecies;
  ...
  const getSelectedSpeciesListFor = (speciesValue) => {
    ...
    if (speciesValue === "-- Alla dagfjärilar --") return allSpecies;
  ...
  const exportToExcel = (rowsArg = results, modeArg = viewMode) => {
    ...
    const filename = `dagfjarilar_${selectedSpecies.replaceAll(" ", "_").replaceAll("--", "")}_${fromYear}${month ? `_${month}` : ""}.xlsx`;
  ...
  const exportToPdf = async () => {
    ...
    try {
      ...
      const filename = `dagfjarilar_${currentViewModeRef.current}_${selectedSpecies.replaceAll(" ", "_").replaceAll("--", "")}_${fromYear}${month ? `_${month}` : ""}.pdf`;
      pdf.save(filename);
      ...
      <div style={styles.shell}>
        <div style={styles.topBar}>
          <div style={{ display: "flex", alignItems: "center", gap: 14, minWidth: 0 }}>
            <h1 style={{ margin: 0, fontSize: 22 }}>Dagfjärilar</h1>
          </div>
